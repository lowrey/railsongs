namespace :railsongs do
  
  # rake RAILS_ENV=production railsongs:create:admin[name@example.com,somepass]
  namespace :create do
  ...
  namespace :read do
    ...
    # rake RAILS_ENV=production railsongs:read:artists[w2] --trace
    ...
    # rake RAILS_ENV=production railsongs:read:artist[w2,Radiohead] --trace
    ...
    # rake RAILS_ENV=production railsongs:read:itunes["/Volumes/toastport/iTunes", toastport] --trace
